...
export const metadata: Metadata = {
  title: "Privacy Policy — Theatre Diary",
};
    ...
    <div className="mx-auto max-w-3xl px-4 py-12 sm:py-16">
      ...
      <div className="prose prose-gray max-w-none text-sm leading-relaxed space-y-6">
        ...
        <section>
          ...
          <p>
            Theatre Diary (&quot;we&quot;, &quot;our&quot;, or &quot;us&quot;)
            operates the Theatre Diary mobile application (the
        ...
        <section>
          ...
          <p>
            ...
            at{" "}
            <a
              href="mailto:privacy@theatrediary.app"
              className="text-gray-900 underline"
            >
              privacy@theatrediary.app
            </a>
            .
          </p>
        </section>
